...
void setup_scr_Spotify_Page(lv_ui *ui)
{
	...
	//Write codes Spotify_Page_cont_1
	ui->Spotify_Page_cont_1 = lv_obj_create(ui->Spotify_Page_cont_Spotify);
	lv_obj_set_pos(ui->Spotify_Page_cont_1, 406, 17);
	lv_obj_set_size(ui->Spotify_Page_cont_1, 103, 67);
	lv_obj_set_scrollbar_mode(ui->Spotify_Page_cont_1, LV_SCROLLBAR_MODE_OFF);

	//Write style for Spotify_Page_cont_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->Spotify_Page_cont_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->Spotify_Page_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->Spotify_Page_cont_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_side(ui->Spotify_Page_cont_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->Spotify_Page_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->Spotify_Page_cont_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->Spotify_Page_cont_1, lv_color_hex(0xa5a5a5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->Spotify_Page_cont_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->Spotify_Page_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->Spotify_Page_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->Spotify_Page_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->Spotify_Page_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->Spotify_Page_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->Spotify_Page_img_3, &_matter_icon_alpha_58x54);
	lv_img_set_pivot(ui->Spotify_Page_img_3, 50,50);
	lv_img_set_angle(ui->Spotify_Page_img_3, 0);
	lv_obj_set_pos(ui->Spotify_Page_img_3, 430, 23);
	lv_obj_set_size(ui->Spotify_Page_img_3, 58, 54);
