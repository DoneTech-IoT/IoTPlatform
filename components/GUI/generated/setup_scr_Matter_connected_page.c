...
void setup_scr_Matter_connected_page(lv_ui *ui)
{
	...
	lv_obj_set_style_img_recolor_opa(ui->Matter_connected_page_img_lamp, 212, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_img_recolor(ui->Matter_connected_page_img_lamp, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
