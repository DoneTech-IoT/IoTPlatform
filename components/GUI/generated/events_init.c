...
static void Spotify_Page_cont_1_event_handler (lv_event_t *e)
{
	lv_event_code_t code = lv_event_get_code(e);
...
void events_init_Spotify_Page(lv_ui *ui)
{
	...
	lv_obj_add_event_cb(ui->Spotify_Page_cont_1, Spotify_Page_cont_1_event_handler, LV_EVENT_ALL, NULL);
}
