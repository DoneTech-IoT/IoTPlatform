...
static void Spotify_MainTask(void *pvparameters)
{
    ...
    while (1)
    {
        ...
        case SAVE_NEW_TOKEN:
        {
            ...
            SpiffsWriteTxtFile(InterfaceHandler->ConfigAddressInSpiffs, "refresh_token", PrivateHandler.token.RefreshToken, NULL, NULL);
...
static bool Spotify_TokenRenew(void)
{
    ...
    SpiffsReadTxtFile(InterfaceHandler->ConfigAddressInSpiffs, "refresh_token", receivedData, NULL, NULL);
...
static void Spotify_GetToken(char *code, size_t SizeOfCode)
{
    ...
    Spotify_ValueOfVariables(receivedData, sizeof(receivedData));
}
